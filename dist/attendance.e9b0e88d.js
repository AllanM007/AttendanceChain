...
var CONTRACT_NAME = "dev-1645512776188-28619302539481" || 'attendance-chain';
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/mzawadi", "/.near/validator_key.json"),
...
},{"near-api-js":"../node_modules/near-api-js/lib/browser-index.js","./config":"config.js"}],"attendance.js":[function(require,module,exports) {
"use strict";
...
var currentLesson;
var submitButton = document.querySelector('form button'); // Display the signed-out-flow container
...
function _fetchLessons() {
  _fetchLessons = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 2:
            currentLesson = _context.sent;
            document.querySelectorAll('[data-behavior="lessons"]').forEach(function (el) {
              // set divs, spans, etc
              el.innerText = currentLesson;

              for (var i = 0; i < currentLesson.length; i++) {
                // append each lesson to our page
                var cardHTML = "<div class=\"row\">\n      <div class=\"col-sm-6\">\n      <div class=\"card-body\">\n      <h5 class=\"card-title\">Lesson Name: ".concat(currentLesson[i].lessonname, "</h5>\n      <p class=\"card-text\">").concat(currentLesson[i].sender, "</p>\n      <a href=\"/attendance.html/").concat(currentLesson[i].lessonid, "\" class=\"btn btn-primary\">View Lesson</a>\n      </div></div>\n      </div>");
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","attendance.js"], null)
//# sourceMappingURL=/attendance.e9b0e88d.js.map