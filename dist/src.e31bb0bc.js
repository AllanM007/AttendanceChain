...
document.querySelector('form').onsubmit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
    var _event$target$element, fieldset, id, name, time, school;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _event$target$element = event.target.elements, fieldset = _event$target$element.fieldset, id = _event$target$element.id, name = _event$target$element.name, time = _event$target$element.time, school = _event$target$element.school; // disable the form while the value gets updated on-chain
...
document.querySelector('input#id').oninput = function (event) {
...
function fetchLesson() {
  return _fetchLesson.apply(this, arguments);
} // `nearInitPromise` gets called on page load


function _fetchLesson() {
  _fetchLesson = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
